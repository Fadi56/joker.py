...
"""%(R,Y,V,G,N)
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCRrRgcJjsnNm5Bi5ZenRGnw')
                time.sleep(1)
                menu()
...
"""%(R,Y,N)
    ...
    print (R+15 * '-'+ Y +'[ \033[1;97mMenu'+N+G+' ]'+R+ 15* '-'+N)
    print (W + ' 1.' + N + ' Start Cracking')
    print (W + ' 2.' + N + ' Dump Group ID\'s')
    print (W + ' 3.' + N + ' Dump Phone Numbers')
    print (W + ' 4.' + N + ' Profile Guard')
    print (W + ' 5.' + N + ' Auto Reaction')
    print (W + ' 6.' + N + ' Auto Report')
    print (W + ' 7.' + N + ' Developer')
    print (W + ' 8.' + Y + ' Logout')
    print (W + ' 0.' + R + ' Exit')
    print ('')
    pilih()
...
def pilih():
    ...
    if zedd == '':
        ...
        os.system('clear')
        print (G + 'Bye Bye Tool joker<3'+N)
...
"""%(R,Y,N)
    ...
    print (G+'['+W+'01'+Y+'] Enable'+N)
    print (G+'['+W+'02'+Y+'] Disable'+N)
...
"""%(R,Y,N)
	...
	print ("  \033[1;93m«---•◈•---Developed By -joker--•◈•---»") #Dev: joker
	print ('\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 joker.py)↩\033[1;97m....')
...
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;96m ....joker BlackMafia....... \033[1;93m :
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;96m +923115962208"""
